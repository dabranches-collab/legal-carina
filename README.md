...
- O `main` contém quatro correcções validadas posteriores ao artefacto actualmente publicado; a publicação 0.10.12 foi autorizada em 14-09-2026 e só avança depois de todos os gates verdes.
