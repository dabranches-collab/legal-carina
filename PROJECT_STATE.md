...
- Branch `codex/client-summary-cards-0.10.19`: cartões de contas enviados ao GitHub em `b784a1f5d411b29baa92ff06728a9491fc5d3c69`; listas de clientes no commit `4d88ac4`, cujo push deve ser confirmado. `origin/main` permanece em `bd8159f59840db88dbc91e8627a1cc57d5f221f1`. A produção permanece em 0.10.18 (deployment `cee7d3d1-709b-4436-aa99-a1cb8c755af7`, version `4f24cadf-9d5a-4844-9ee5-be5c29346550`, activa desde `2026-09-16 07:01:39 UTC`). A publicação da 0.10.19 não foi autorizada nesta fase.
