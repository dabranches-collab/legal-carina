...
- **Clientes > Provisões**, imediatamente depois de Avenças, mostra por defeito apenas contas com saldo positivo. O filtro pode ser retirado para consultar o histórico. Pesquisa, filtros de coluna, XLSX e impressão usam a tabela comum. Os clientes continuam nas categorias Particulares/Empresas.
