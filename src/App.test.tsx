...
describe('interface principal', () => {
  ...
  it('mantém utilizadores dentro da Administração', async () => {
    ...
    expect(screen.queryByRole('button',{name:'Importações'})).not.toBeInTheDocument()
    expect(screen.queryByRole('button',{name:'Revisão de importações'})).not.toBeInTheDocument()
