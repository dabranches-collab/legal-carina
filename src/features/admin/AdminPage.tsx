...
type Role = 'admin'|'manager'|'billing'|'professional'|'viewer'|'auditor'
...
const roleHelp:Record<Role,string> = {
  admin:'Gestão integral da aplicação, utilizadores e configurações.', manager:'Gestão operacional dentro das Sociedades autorizadas; os valores financeiros dependem de autorização separada.', billing:'Facturação, recebimentos e valores das sociedades autorizadas.', professional:'Registos e processos dentro das sociedades autorizadas.', viewer:'Consulta dos dados autorizados, sem alteração.', auditor:'Consulta e auditoria dos dados autorizados, sem alteração operacional.',
}
