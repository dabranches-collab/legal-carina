...
type Props={value:string;onChange:(value:string)=>void;required?:boolean;disabled?:boolean;ariaLabel?:string;className?:string}

export function CalendarDateInput({value,onChange,required=false,disabled=false,ariaLabel,className=''}:Props){
