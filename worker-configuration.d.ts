/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.env.local` (hash: e5deb80b4d6ebc333c0f7725aca167e3)
// Runtime types generated with workerd@1.20260811.1 2026-08-16
interface __BaseEnv_Env {
	TRANSLATION_LIMITER: RateLimit;
	ASSETS: Fetcher;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VITE_SUPABASE_URL" | "VITE_SUPABASE_PUBLISHABLE_KEY" | "VITE_APP_ENV" | "OPENAI_API_KEY" | "AZURE_TRANSLATOR_KEY" | "AZURE_TRANSLATOR_REGION">> {}
}
