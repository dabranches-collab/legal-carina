...
select policies_are('public', 'work_entries', array['work_entries_insert_professional', 'work_entries_select_member', 'work_entries_update_professional'], 'work_entries policies are explicit');
...
select throws_ok(
  $$insert into public.work_entries (firm_id, work_date, client_id, professional_id, activity_description, duration_minutes) values ('10000000-0000-0000-0000-000000000001', current_date, '20000000-0000-0000-0000-000000000001', '30000000-0000-0000-0000-000000000001', 'Teste', -1)$$,
  '23514', null, 'negative duration is rejected'
);
select throws_ok(
  $$insert into public.work_entries (firm_id, work_date, client_id, professional_id, activity_description, duration_minutes, is_paid) values ('10000000-0000-0000-0000-000000000001', current_date, '20000000-0000-0000-0000-000000000001', '30000000-0000-0000-0000-000000000001', 'Teste', 60, true)$$,
...
insert into public.work_entries (
  id, firm_id, work_date, client_id, professional_id, activity_description,
  ...
  'Trabalho sintético faturado', 60, 100, true, current_date
);
