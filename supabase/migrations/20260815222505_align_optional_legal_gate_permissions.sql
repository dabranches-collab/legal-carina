...
comment on function private.has_accepted_current_terms(uuid) is
  'Returns true when every currently published legal document is accepted; also true when the optional legal-document module has no published documents.';
