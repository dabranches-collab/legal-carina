...
with memberships as materialized(
 ...
 select w.id,w.work_date,w.effective_amount,c.display_name client_sort
 ...
 select p.page_position,w.id,w.work_date,w.activity_description,w.duration_minutes,
