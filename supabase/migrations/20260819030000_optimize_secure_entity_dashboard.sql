-- Evita repetir verificações de âmbito e permissões por cada linha.
-- O perfil é resolvido uma vez; utilizadores sem âmbito global mantêm o caminho restritivo.
