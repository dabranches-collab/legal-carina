...
- Fase operacional do trabalho na ficha: «Em curso», «Terminado» ou «Cancelado», independente dos estados de facturação e pagamento. A lista mostra a fase, contagem de trabalhos em curso/terminados e filtro por fase. Alteração local compilada e validada por TypeScript/lint; a sessão autenticada do browser local expirou antes da verificação visual actualizada.
