...
- Foi preparada localmente `20260817084428_add_full_work_entry_edit.sql`, com RPC auditada para actualização completa e eliminação. A eliminação exige administrador, motivo e movimento não facturado; não foi aplicada ao remoto.
